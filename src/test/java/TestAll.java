...
public class TestAll {
    ...
    private static TestAll instance;

    private TestAll() {

    }

    public void typesCheck(TypesDao typesDao, UserDao userDao) {
    ...
    public void categoriesCheck(CategoriesDao categoriesDao, UserDao userDao) {
    ...
    public void manufacturersCheck(ManufacturesDao manufacturesDao, UserDao userDao) {
    ...
    public void placesCheck(PlacesDao placesDao, UserDao userDao) {
    ...
    public void locationPositionsCheck(LocationPositionsDao locationPositionsDao, UserDao userDao) { // TODO
    ...
    public void usersCheck(UserDao userDao, UsersManager usersManager) {
    ...
    public void devicesCheck(DeviceDao deviceDao, DevicesManager devicesManager, UserDao userDao) {
    ...
    public void worksCheck(WorkDao workDao, WorksManager worksManager, DeviceDao deviceDao, UserDao userDao) {
    ...
    public static TestAll getInstance() {
        if(instance == null) {
            instance = new TestAll();
        } else {
            throw new IllegalArgumentException("Объект TestAll уже создан");
        }
        return instance;
    }
}
